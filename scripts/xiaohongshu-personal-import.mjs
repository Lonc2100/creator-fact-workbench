...
const DEFAULT_RAW_DIR = path.join(process.cwd(), ".local", "xiaohongshu-personal-v0", "raw");
const DEFAULT_OUT_DIR = path.join(process.cwd(), ".local", "xiaohongshu-personal-v1");
...
const preview = {
  ...
  importResult: options.save ? await importXiaohongshuPersonalCaptures(captures) : undefined
};
