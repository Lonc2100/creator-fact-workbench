...
Generated at: 2026-06-11T09:06:14.164Z
Mode: read queue and prepare main/Ops dispatch prompt only

## MAINLINE-VIDEO-ACCOUNT-MANUAL-DATA-INTAKE-127
...
- Can dispatch: false
- Suggested thread title: Worker 127 - Video Account Manual Data Intake
- Reason: Saving real Video Account data requires user-provided owned content-level data with a stable work ID/link and explicit confirmation before save.
...
Allowed files:
- docs/handoffs/MAINLINE-VIDEO-ACCOUNT-MANUAL-DATA-INTAKE-127-worker-handoff.md
...
Handoff path: docs/handoffs/MAINLINE-VIDEO-ACCOUNT-MANUAL-DATA-INTAKE-127-worker-handoff.md
User gate state: blocked_by_user_gate
User gate reason: Saving real Video Account data requires user-provided owned content-level data with a stable work ID/link and explicit confirmation before save.
